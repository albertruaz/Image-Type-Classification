...
def analyze_errors(model_path: str, test_data_path: str, top_k: int = 10, output_path: str = None):
    ...
    if output_path:
        # 필요한 컬럼만 선택
        simple_errors = errors_df[['true_label', 'predicted_label', 'confidence', 'image_path']].copy()
...
def main():
    ...
    parser.add_argument('--model', type=str, 
                       default='results/run_20251228_193123_39cb9957/model/best_model.pth',
                       help='모델 경로')
